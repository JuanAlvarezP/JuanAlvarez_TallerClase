...
namespace JuanAlvarez_TallerClase.Controllers
{
    public class BurgersController : Controller
    {
        ...
        public BurgersController(JuanAlvarez_TallerClaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'JuanAlvarez_TallerClaseContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'JuanAlvarez_TallerClaseContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
